...
<html lang="en">
  <head>
    ...
    <meta name = "keywords" content = "Crypto, HCA, Harcomia, BEP-20, bep20" />
    <meta name = "description" content = "Harcomia MetaMask Connector" />
    ...
    <title>Harcomia (BSC and HCM with logo Connector to MetaMask)</title>
    ...
    <link rel="icon" href="img/logo-hac.png" type="image/png">
  </head>
  <body>
              ...
              <div class="tm-section-wrap">
                <section id="intro" class="tm-section">
                    <div class="tm-bg-grey-transparent tm-intro">
                      <h2 class="tm-section-title mb-5 text-uppercase tm-color-primary">Get connected to the Binance Smart Chain Network and add Harcomia with MetaMask</h2>
                        <ul class="list-steps">
